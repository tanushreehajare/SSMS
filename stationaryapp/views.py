...
def reset_faculty_password(request):
    ...
    return render(request, "resetfacultypassword.html", {'messages': messages.get_messages(request)})
...
def facultypage(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'faculty_welcome_page.html', context)
...
def view_users(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'view_users_page.html', {'users': users})
    else:
        messages.error(request, "Only admins can access this page.")
        return render(request, 'view_users_page.html')
...
def add_faculty_user(request):
    if request.method == "POST" and request.user.is_authenticated and request.user.is_superuser:
        ...
        if not email.endswith('@somaiya.edu'):
            ...
            return render(request, 'add_faculty_page.html')
...
def my_requests(request):
    ...
    return render(request, 'view_my_requests.html', context)
...
def stationary_and_faculty(request):
    ...
    return render(request, 'stationary_and_faculty.html', context)
...
def assign_stationary(request):
    ...
    return render(request, 'assign_stationary_page.html', context)
...
def view_stationary(request):
    ...
    return render(request, 'view_stationary_page.html', context )
...
def view_faculty(request):
    ...
    return render(request, 'view_faculty_page.html', context )
...
def view_assignments(request):
    ...
    return render(request, 'view_assignment_page.html', context)
...
def edit_stationary(request):
    ...
    return render(request, 'edit_stationary_page.html', context)
...
def image_feed(request):
    ...
    return render(request, 'image_feed.html', {'images': images})
...
def my_assignments(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'myassignments.html', {'assignments': assignments, 'faculty_user': faculty_user,'unique_stationary_names': unique_stationary_names})
    else:
        return render(request, 'registration/login.html', {})
...
def forgetpassword(request):
    try:
        if request.method == 'POST':
            ...
            messages.success(request, 'You Will Receive An Email')
